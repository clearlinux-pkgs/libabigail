...
Version  : 2.1
Release  : 30
URL      : https://mirrors.kernel.org/sourceware/libabigail/libabigail-2.1.tar.gz
Source0  : https://mirrors.kernel.org/sourceware/libabigail/libabigail-2.1.tar.gz
...
%prep
%setup -q -n libabigail-2.1
cd %{_builddir}/libabigail-2.1
%patch1 -p1
%patch2 -p1
pushd ..
cp -a libabigail-2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664153139
...
/usr/include/libabigail/abg-elf-reader-common.h
