...
Source0  : https://mirrors.kernel.org/sourceware/libabigail/libabigail-2.7.tar.xz
...
%prep
%setup -q -n libabigail-2.7
cd %{_builddir}/libabigail-2.7
%patch -P 1 -p1
pushd ..
cp -a libabigail-2.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744728515
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libabigail.so.6.0.0
/usr/lib64/libabigail.so.6
/usr/lib64/libabigail.so.6.0.0
